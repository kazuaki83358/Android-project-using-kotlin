...
class OtpActivity : AppCompatActivity() {
        ...
        override fun onVerificationFailed(e: FirebaseException) {
            ...
            when (e) {
                is FirebaseAuthInvalidCredentialsException -> {
                    Toast.makeText(this@OtpActivity, "Invalid phone number.", Toast.LENGTH_SHORT).show()
                }
                is FirebaseTooManyRequestsException -> {
                    Toast.makeText(this@OtpActivity, "Quota exceeded.", Toast.LENGTH_SHORT).show()
                }
                else -> {
    ...
    private fun sendToMain() {
        ...
        finish() // Finish the OTP activity to remove it from the back stack
    }
